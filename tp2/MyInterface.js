...
export class MyInterface extends CGFinterface {
	...
	// Interface group for shaders
	addShadersGroup(selectedShaders) {
        var group = this.gui.addFolder("Shaders");
		group.open();
		group.add(this.scene.graph, 'nodeIDSelected', selectedShaders).name('Node Selected');
